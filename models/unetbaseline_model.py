...
def define_G(cfg, input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    Parameters:
        ...
        netG (str) -- the architecture's name: unet_256 | unet_128 | unet_256_sh | unet_128_sh
    ...
    Our current implementation provides two types of generators:
        ...
        U-Net + SH: [unet_256_sh] and [unet_128_sh]
        UNet with Spherical Harmonics branch for ERP depth estimation.
